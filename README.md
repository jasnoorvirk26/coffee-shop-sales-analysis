...
## Overview
This project involves developing an interactive dashboard using Excel to analyze coffee shop sales data. The goal is to provide actionable insights into store performance, sales trends, and pricing strategies, helping optimize operations and increase profitability. The use of advanced data visualization techniques and interactive elements makes the findings both accessible and impactful.
